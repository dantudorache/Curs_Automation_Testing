...
# 	  O abordare de software development in centrul careia stau scenarii de testare bazate
# 	  pe asteptarile functionale ale clientului pentru aplicatie
#
# 	  Atunci cand dezvoltam o aplicatie cu BDD lucrurile se vor desfasura in felul urmator:
# 	  1. Definim scenariile de testare intr-un limbaj comun, de regula engleza,
# 	  care sa fie inteles de catre toti participantii si persoanele implicate in proiect.
...
# 	  3. Scriem codul care sa implementeze aplicatia plecand de la testele automate scrise anterior,
# 	  rulam din nou testele si de data asta asteptarea e ca acele teste sa fie passed
...
#
# 	  Avantaje:
# 	  1. Oricine se va uita peste suita noastra de teste automate va intelege usor ce am testat si
# 	  ce functionalitati ale aplicatiei au fost acoperite
...
# 	  Rulam testele, si asteptarea este ca acestea sa fie failed, deoarece codul inca nu a fost scris
# 	  2. Scriem codul care sa implementeze aplicatia plecand de la testele automate scrise anterior,
# 	  rulam din nou testele si de data asta asteptarea e ca acele teste sa fie passed
...
# 4. Background = un context general valabil pentru majoritatea scenariilor de testare/pasi de tipul given care sunt valabili
# pentru mai multe scenarii (pentru a evita duplicarea codului)
